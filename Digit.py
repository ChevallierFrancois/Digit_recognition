...
# Read data
train = pd.read_csv('C:/Users/Francois Chevallier/Desktop/data/train.csv')
labels = train.ix[:,0].values.astype('int32')
X_train = (train.ix[:,1:].values).astype('float32')
X_test = (pd.read_csv('C:/Users/Francois Chevallier/Desktop/data/test.csv').values).astype('float32')
